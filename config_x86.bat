...
distr\x86\fart "C:\Program Files\Zabbix Agent\zabbix_agentd.conf" "# Timeout=3" "Timeout=30"
distr\x86\fart "C:\Program Files\Zabbix Agent\zabbix_agentd.conf" "zabbix_agentd.conf.d\\" "zabbix_agentd.conf.d\*.conf"
